...
class CreateRegistrarAusenciasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('registrar_ausencias', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('registrar_ausencias');
    }
}
