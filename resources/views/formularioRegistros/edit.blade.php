...
<form action="{{url('/formularioRegistros/' . $formularioRegistro->id)}}" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        value="{{ isset($formularioRegistro->fecha)?$formularioRegistro->fecha:old('Fecha') }}"
        >
