...
<form action="{{url('/registrarUFC/registrarUnidad')}}" id="contactUni"  class="form-horizontal" method="post" enctype="multipart/form-data">
...
<script src="{{ asset('dist/js/validacionesUnidad.js') }} "></script>
