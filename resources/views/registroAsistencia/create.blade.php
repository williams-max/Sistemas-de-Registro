...
<form action="{{url('/registroAsistencia')}}" class="form-horizontal" method="post" enctype="multipart/form-data">
...
<div class="row">
    ...
    <div class="col-5">
        ...
        <input type="text" class="form-control  {{$errors->has('firma')?'is-invalid':'' }}" name="firma" id="firma" 
...
<div class="row">
   <div class="col-5 ">       
    ...
    <div class="col-5">  
        <a href="{{url('registroAsistencia')}}"class="btn btn-secondary float-right">Regresar</a>
    </div> 
