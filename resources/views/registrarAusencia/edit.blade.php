...
<form action="{{url('/registroAsistenciaAuxiliar/registrarAusencia/' . $registro->id)}}" method="post" enctype="multipart/form-data">

    {{csrf_field()}}
    {{method_field('PATCH')}}

    <h3 class="text-center">EDITAR FORMULARIO REGISTRO DE REPOSICION</h3> 
    <BR></BR>
